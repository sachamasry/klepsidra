defmodule Klepsidra.LocalisationTest do
  ...
  describe "localisation_languages" do
    ...
    @invalid_attrs %{"iso_639-3": nil, "iso_639-2": nil, "iso_639-1": nil, language_name: nil}
    ...
    test "get_language!/1 returns the language with given id" do
      language = language_fixture()
      assert Localisation.get_language!(language."iso_639-3") == language
    end
    ...
    test "create_language/1 with valid data creates a language" do
      ...
      assert language."iso_639-3" == "some iso_639-3"
      assert language."iso_639-2" == "some iso_639-2"
      assert language."iso_639-1" == "some iso_639-1"
    ...
    test "update_language/2 with valid data updates the language" do
      ...
      update_attrs = %{
        "iso_639-3": "some updated iso_639-3",
        "iso_639-2": "some updated iso_639-2",
        "iso_639-1": "some updated iso_639-1",
        language_name: "some updated language_name"
      }

      assert {:ok, %Language{} = language} = Localisation.update_language(language, update_attrs)
      assert language."iso_639-3" == "some updated iso_639-3"
      assert language."iso_639-2" == "some updated iso_639-2"
      assert language."iso_639-1" == "some updated iso_639-1"
    ...
    test "update_language/2 with invalid data returns error changeset" do
      ...
      assert language == Localisation.get_language!(language."iso_639-3")
    end

    test "delete_language/1 deletes the language" do
      language = language_fixture()
      assert {:ok, %Language{}} = Localisation.delete_language(language)
      assert Localisation.get_language!(language."iso_639-3") == nil
    end
