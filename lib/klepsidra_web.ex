defmodule KlepsidraWeb do
  ...
  def router do
    quote do
      ...
      import KlepsidraWeb.CSP, only: [put_content_security_policy: 2]
    end
  end
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: KlepsidraWeb.Router,
        statics: KlepsidraWeb.static_paths()
    end
  end
